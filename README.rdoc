...
{<img src="https://secure.travis-ci.org/sul-dlss/rspec-solr.png?branch=master" alt="Build Status" />}[http://travis-ci.org/sul-dlss/rspec-solr] {<img src="https://coveralls.io/repos/sul-dlss/rspec-solr/badge.png" alt="Coverage Status" />}[https://coveralls.io/r/sul-dlss/rspec-solr] {<img src="https://gemnasium.com/sul-dlss/rspec-solr.png" alt="Dependency Status" />}[https://gemnasium.com/sul-dlss/rspec-solr] {<img src="https://badge.fury.io/rb/rspec-solr.svg" alt="Gem Version" />}[http://badge.fury.io/rb/rspec-solr]
